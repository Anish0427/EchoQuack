...
- Copy the `apiKey`, `authDomain`, `projectId`, etc., and paste them into `.env.local`.
...
- **Background Support**: Uses Firebase Cloud Messaging (FCM) to reach devices even when the browser tab is closed.
